...
RSpec.describe ProductsController, type: :controller do
  ...
  let(:valid_attributes) {
    {sku_code: "01010101", name: "Test1", price: 33.50}
  }

  let(:invalid_attributes) {
    {sku_code: "0101", name: "", price: ""}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {sku_code: "12345678", name: "Test2", price: 95.25}
      }
      ...
      it "updates the requested product" do
        ...
        product.reload
        expect(product['sku_code']).to match(new_attributes[:sku_code])
        expect(product['name']).to match(new_attributes[:name])
