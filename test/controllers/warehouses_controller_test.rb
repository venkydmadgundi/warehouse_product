...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { max_capacity: @warehouse.max_capacity, name: @warehouse.name, pincode: @warehouse.pincode, wh_code: @warehouse.wh_code } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { max_capacity: @warehouse.max_capacity, name: @warehouse.name, pincode: @warehouse.pincode, wh_code: @warehouse.wh_code } }
